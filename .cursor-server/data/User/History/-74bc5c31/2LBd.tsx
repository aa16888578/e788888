...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // 用戶角色判斷
  const isAdmin: boolean = user?.email?.includes('admin') || user?.email === 'admin@cvvbot.com' || false;
  const isAgent: boolean = user?.email?.includes('agent') || user?.email?.includes('admin') || false;
