 ...
 * POST /api/cvv/import
 */
router.post('/import', async (req: Request, res: Response): Promise<Response | void> => {
  try {
 ...
 */
router.patch('/cards/:id/status', async (req: Request, res: Response): Promise<Response | void> => {
  try {
    const cardId = req.params.id;
 ...
 */
router.patch('/cards/batch-status', async (req: Request, res: Response): Promise<Response | void> => {
  try {
