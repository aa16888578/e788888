// 代理系統類型定義
import { FieldValue } from '../utils/firebase-admin';
...
export interface Agent {
  ...
  joinDate: Date | FieldValue;       // 加入日期
  lastActive: Date | FieldValue;     // 最後活躍時間
  createdAt: Date | FieldValue;      // 創建時間
  updatedAt: Date | FieldValue;      // 更新時間
}
...
export interface AgentCommission {
  ...
  orderDate: Date | FieldValue;      // 訂單日期
  commissionDate: Date | FieldValue; // 佣金產生日期
  paidDate?: Date | FieldValue;      // 支付日期
  notes?: string;                    // 備註
  createdAt: Date | FieldValue;      // 創建時間
  updatedAt: Date | FieldValue;      // 更新時間
}
...
export interface AgentWithdrawal {
  ...
  requestDate: Date | FieldValue;    // 申請日期
  processDate?: Date | FieldValue;   // 處理日期
  completeDate?: Date | FieldValue;  // 完成日期
  notes?: string;                    // 備註
  createdAt: Date | FieldValue;      // 創建時間
  updatedAt: Date | FieldValue;      // 更新時間
}
...
export interface AgentPerformance {
  ...
  startDate: Date | FieldValue;      // 統計開始日期
  endDate: Date | FieldValue;        // 統計結束日期
...
export interface AgentReferral {
  ...
  referralDate: Date | FieldValue;   // 推薦日期
  bonusDate?: Date | FieldValue;     // 獎金發放日期
  createdAt: Date | FieldValue;      // 創建時間
  updatedAt: Date | FieldValue;      // 更新時間
}
