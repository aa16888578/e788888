...
export default function ExchangeRateManagement() {
  ...
  return (
    <div className="space-y-6">
      {/* 頁面標題 */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">匯率管理</h1>
        <p className="mt-2 text-sm text-gray-600">
          監控和管理 USDT 對各國貨幣的匯率，支持實時更新和歷史追蹤
        </p>
      </div>
      ...
      <div className="bg-white overflow-hidden shadow rounded-lg">
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900">當前匯率</h3>
            <button
              ...
              <div key={rate.id} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-1 text-xs text-gray-500">
                    ...
                    <span>{rate.lastUpdate.toLocaleTimeString()}</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">匯率轉換器</h3>
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            <div className="text-center">
              <p className="text-sm text-gray-500">轉換結果</p>
              <p className="text-2xl font-bold text-gray-900">
                {formatCurrency(100, selectedCurrency)}
              </p>
              <p className="text-sm text-gray-500">
                100 USDT = {formatCurrency(100, selectedCurrency)}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">匯率趨勢</h3>
          <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              <CurrencyDollarIcon className="h-12 w-12 text-gray-400 mx-auto mb-2" />
              <p className="text-gray-500">匯率圖表將在這裡顯示</p>
              <p className="text-sm text-gray-400">支持 24小時、7天、30天趨勢</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">匯率設置</h3>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <select className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                <option value="chainlink">Chainlink (主要)</option>
                <option value="coingecko">CoinGecko (備用)</option>
                <option value="binance">Binance (第三)</option>
              </select>
            </div>
