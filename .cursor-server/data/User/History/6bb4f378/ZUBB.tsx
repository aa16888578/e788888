...
// 模擬商品數據 (基於圖片中的國家/地區商品)
const products = [
  { code: 'AR', name: '阿根廷', flag: '🇦🇷', rate: '40%-70%', stock: 2417, type: 'basic' },
  { code: 'BH', name: '巴林', flag: '🇧🇭', rate: '40%-70%', stock: 255, type: 'basic' },
  { code: 'BO', name: '玻利維亞', flag: '🇧🇴', rate: '55%-75%', stock: 2269, type: 'premium' },
  { code: 'BR', name: '巴西', flag: '🇧🇷', rate: '20%-50%', stock: 28373, type: 'premium' },
  { code: 'CL', name: '智利', flag: '🇨🇱', rate: '45%-75%', stock: 9848, type: 'premium' },
  { code: 'CL_FULL', name: '智利_全資', flag: '🇨🇱', rate: '40%-70%', stock: 1169, type: 'basic' },
  { code: 'DE', name: '德國', flag: '🇩🇪', rate: '50%-80%', stock: 2109, type: 'hot' },
  { code: 'DO', name: '多米尼加', flag: '🇩🇴', rate: '55%-75%', stock: 1475, type: 'premium' },
  { code: 'EC', name: '厄瓜多爾', flag: '🇪🇨', rate: '40%-70%', stock: 2883, type: 'premium' },
  { code: 'EE', name: '愛沙尼亞', flag: '🇪🇪', rate: '55%-75%', stock: 451, type: 'basic' },
  { code: 'ES', name: '西班牙', flag: '🇪🇸', rate: '50%-80%', stock: 22291, type: 'premium' },
  { code: 'ES_TOP', name: '西班牙_頂級全資', flag: '🇪🇸', rate: '50%-80%', stock: 7091, type: 'hot' },
  { code: 'FI', name: '芬蘭', flag: '🇫🇮', rate: '55%-75%', stock: 594, type: 'basic' },
  { code: 'FR', name: '法國', flag: '🇫🇷', rate: '40%-70%', stock: 16965, type: 'premium' },
  { code: 'FR_FULL', name: '法國_全資', flag: '🇫🇷', rate: '40%-70%', stock: 9278, type: 'basic' },
  { code: 'GB', name: '英國', flag: '🇬🇧', rate: '40%-70%', stock: 22320, type: 'premium' },
];
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      <span className="font-bold text-white">{product.code}_{product.name}</span>
                      {product.type === 'hot' && <span className="text-red-500">🔥</span>}
                      {product.type === 'premium' && <span className="text-blue-400">💎</span>}
                    </div>
                    <div className="text-sm text-gray-400">
                      全資 {product.rate} 【{product.stock}】
                    </div>
                  </div>
                </div>
